...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 2176008);
	iki_vhdl_file_variable_register(dp + 2176064);
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 2181680, dp + 2707848, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 2181624, dp + 2708240, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 2181568, dp + 2708128, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 2182088, dp + 2708352, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 2181736, dp + 2708016, 0, 7, 0, 7, 8, 1);
